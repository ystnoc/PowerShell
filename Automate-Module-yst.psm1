...
[CmdletBinding(SupportsShouldProcess=$True)]
    ...
    $DownloadPath = $null
    If ($Token -ne $null) {
        $DownloadPath = "$($AutomateURL)/Labtech/Transfer/Software/LabTech/Agent_Install.exe"
    ...
    If (($Global:Automate.ServerAddress -like "*$($Server)*") -and $Global:Automate.Online -and !$Force) {
        ...
        Write-Verbose "Downloading Automate Agent from $($AutomateURL)"
            ...
            If ($InstallExitCode.ExitCode -eq 0) {
                ...
                #Write-Host "The Automate Installer failed. Waiting 55 Seconds..." -ForegroundColor Red
                #Start-Sleep -s 55
